...
public interface UserRepository extends JpaRepository<User, Integer> {
   ...
   * @return
   */
  public Boolean existsByEmailAndUserPassword(String email, String userPassword);
  ...
  void updatePasswordById(@Param("id") Long userId, @Param("password") String userPassword);
  ...
  void updatePhoneNumberById(@Param("id") Long userId, @Param("phoneNumber") String phoneNumber);
